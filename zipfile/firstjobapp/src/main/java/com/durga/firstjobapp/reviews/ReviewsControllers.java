...
public class ReviewsControllers {
    ...
    @GetMapping("")
    public ResponseEntity<List<Reviews>> findAll(@PathVariable Long companyId){
        return new ResponseEntity<>(reviewsService.findAll(companyId), HttpStatus.OK);
    }

    @GetMapping("/{reviewId}")
    public ResponseEntity<Reviews> findById(@PathVariable Long companyId,@PathVariable Long reviewId){
        Reviews review = reviewsService.findById(companyId,reviewId);
    ...
    @PutMapping("/{reviewId}")
    public ResponseEntity<String> updateReview(@PathVariable Long companyId,@PathVariable Long reviewId,@RequestBody Reviews updateReview){
        boolean updated = reviewsService.updateReview(companyId,reviewId,updateReview);
    ...
    public ResponseEntity<String> deleteReviews(@PathVariable Long companyId,@PathVariable Long reviewId){
        boolean deleted = reviewsService.deleteById(companyId,reviewId);
